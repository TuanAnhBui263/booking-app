...
const ToursManagement = () => {
  const [tours] = useState([
    { id: 1, name: 'Matterhorn Base Trek', location: 'Switzerland', price: 299, duration: '5 days', status: 'Active', bookings: 45 },
    { id: 2, name: 'Mont Blanc Circuit', location: 'France', price: 499, duration: '7 days', status: 'Active', bookings: 32 },
    { id: 3, name: 'Dolomites Adventure', location: 'Italy', price: 399, duration: '6 days', status: 'Inactive', bookings: 18 },
    { id: 4, name: 'Swiss Alps Explorer', location: 'Switzerland', price: 599, duration: '8 days', status: 'Active', bookings: 28 }
  ]);
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b">
                ...
                <th className="text-left py-3 px-4 text-gray-600 font-semibold">Bookings</th>
